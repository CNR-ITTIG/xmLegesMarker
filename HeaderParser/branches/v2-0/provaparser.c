...
int main(int argc, char **argv)
{
    ...
    string footer = (char *) xmlNodeListGetString(NULL, lastcomma_node, 1);
    headerparser.parseFooter(footer, lastcomma_node, meta, descrittori, formulafinale, conclusione, 0, notes);
