...
&#186;			prexmlAppendString("°");		//GRADO
\xBA				prexmlAppendString("°");		//GRADO

&#146;			prexmlAppendChars(1, '\x92');
...
<InComment>({TKN}+|{Q})		{
							prexmlAppendString(strdup(prexmltext));
							}
...
&quot;			prexmlAppendString("\"");		// convertite virgolette
&nbsp;			prexmlAppendString(" ");		// convertito spazio non divisibile

&[a-z]+;			prexmlAppendString(strdup(prexmltext));	// lasciate entità simboliche

&#128;			prexmlAppendChars(1, '\x80');		//mapping dei caratteri "windows"
&#129;			prexmlAppendChars(1, '\x81');
&#130;			prexmlAppendChars(1, '\x82');
&#131;			prexmlAppendChars(1, '\x83');
&#132;			prexmlAppendChars(1, '\x84');
&#133;			prexmlAppendChars(1, '\x85');
&#134;			prexmlAppendChars(1, '\x86');
&#135;			prexmlAppendChars(1, '\x87');
&#136;			prexmlAppendChars(1, '\x88');
&#137;			prexmlAppendChars(1, '\x89');
&#138;			prexmlAppendChars(1, '\x8A');
&#139;			prexmlAppendChars(1, '\x8B');
&#140;			prexmlAppendChars(1, '\x8C');
&#141;			prexmlAppendChars(1, '\x8D');
&#142;			prexmlAppendChars(1, '\x8E');
&#143;			prexmlAppendChars(1, '\x8F');
&#144;			prexmlAppendChars(1, '\x90');
&#145;			prexmlAppendChars(1, '\x91');

&#147;			prexmlAppendChars(1, '\x93');
&#148;			prexmlAppendChars(1, '\x94');
&#149;			prexmlAppendChars(1, '\x95');
&#150;			prexmlAppendChars(1, '\x96');
&#151;			prexmlAppendChars(1, '\x97');
&#152;			prexmlAppendChars(1, '\x98');
&#153;			prexmlAppendChars(1, '\x99');
&#154;			prexmlAppendChars(1, '\x9A');
&#155;			prexmlAppendChars(1, '\x9B');
&#156;			prexmlAppendChars(1, '\x9C');
&#157;			prexmlAppendChars(1, '\x9D');
&#158;			prexmlAppendChars(1, '\x9E');
&#159;			prexmlAppendChars(1, '\x9F');

&#171;			prexmlAppendChars(1, '\xAB');		//#LEFT-POINTING DOUBLE ANGLE QUOTATION MARK
&#176;			prexmlAppendString("°");
&#187;			prexmlAppendChars(1, '\xBB');		//#RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK

&#224;			prexmlAppendString("\xE0");
&#232;			prexmlAppendString("\xE8");

&#8211;			prexmlAppendString("\x96");			
&#8216;			prexmlAppendString("\'");
&#8217;			prexmlAppendString("\'");
&#8220;			prexmlAppendString("\"");
&#8221;			prexmlAppendString("\"");
...
&#8026;			prexmlAppendString(""); //Elimina punto centrale (bullet)
&#167;				prexmlAppendString(""); //Elimina section symbol

&#[0-9]+;		{
	prexmlAppendString(strdup(prexmltext));	// lasciate entità numeriche  //(..se ne rimangono..)
	printf("\nEntity not found: %s\n", strdup(prexmltext));
	}

&					prexmlAppendString("&"); //prexmlAppendString("&#38;");  & che non delimita un'entità
